...
# 구글 시트 API 인증
creds = Credentials.from_service_account_file(r"C:\Users\ghgh2\OneDrive\바탕 화면\modular-rush-466605-m9-d44d490d0ba3.json", scopes=scopes)
client = gspread.authorize(creds)

# 구글 시트 열기 (본인의 구글 시트 URL로 변경하세요)
sheet_url = "https://docs.google.com/spreadsheets/d/1eDV1eFwtmo2kKKrdistaWKpNr3ASVusNSQSEKSCZYd4/edit?gid=0"#gid=0
