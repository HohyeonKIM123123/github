...
# 데이터 구조 : 배열(리스트), 딕셔너리(튜플){key:value} 형식이 인덱싱하기가 참 어려움 그래서 판다스로 데이터를 상당히 빠르고 쉽게 다룰 수 있게 함.
...
print("컬럼 목록:", df.columns.tolist())      #이거 알면 data["이름"]["나이"] 이거 할 떄 유리할 듯듯 # 열 이름 목록
